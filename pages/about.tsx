...
type AboutSectionData = {
	title: string;
	items: Array<AboutSectionDataItem>;
};
			...
			<List spacing={3}>
				{items.map(({ organisation, positions }) => (
					<ListItem as={Box} key={organisation}>
						...
						{positions.map(
							({ position, description, from, to, technologies }) => (
								<Box
									key={position}
									sx={{
										width: '80vw',
				...
				positions: [
					{
						...
						description:
							'I am currently working at Artera (formerly WELL Health) as a full-stack software engineer on the development of an information system to facilitate communication in healthcare. My work has included a rebranding process, message automations and settings management.',
				...
				positions: [
					{
						...
						description:
							'I helped ContentCal/Adobe to bring scalable, robust social media automation capabilities to Adobe Express platform for millions of users as a full-stack software engineer.',
